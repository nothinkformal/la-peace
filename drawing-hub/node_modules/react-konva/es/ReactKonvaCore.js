...
const StageWrap = (props) => {
    ...
    const suspension = React.useRef(null);
    ...
    const isStrictMode = !!traverseFiber(fiber, true, (node) => node.type === React.StrictMode);
    ...
    const setCanvasVisibility = (mode) => {
        ...
        KonvaRenderer.updateContainer(React.createElement(React.Activity, {
            mode: mode === 'hidden' ? 'hidden' : 'visible',
            children: React.createElement(React.Suspense, { fallback: null }, children.current, suspension.current &&
    ...
    React.useLayoutEffect(() => {
        ...
        if (!stage.current) {
            ...
            fiberRef.current = KonvaRenderer.createContainer(stage.current, ConcurrentRoot, null, isStrictMode, null, identifierPrefix, console.error, console.error, console.error, null);
        }
        return () => {
    ...
    React.useLayoutEffect(() => {
        ...
        children.current = React.createElement(HostConfig.HostTransitionContext.Provider, { value: formStatus }, React.createElement(Bridge, {}, props.children));
