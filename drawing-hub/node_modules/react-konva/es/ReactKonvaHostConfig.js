...
export function startViewTransition(suspendedState, rootContainer, transitionTypes, mutationCallback, layoutCallback, afterMutationCallback, spawnedWorkCallback, passiveCallback, errorCallback, blockedCallback, finishedAnimation) {
    mutationCallback();
    layoutCallback();
    finishedAnimation?.();
    spawnedWorkCallback();
...
export const HostTransitionContext = /* @__PURE__ */ React.createContext(NotPendingTransition);
