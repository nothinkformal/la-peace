...
import { n as Konva, r as Konva$1 } from "./lib-D1JmWYdB.js";
...
var require_react_reconciler_development = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	module.exports = function($$$config) {
		...
		function addObjectToProperties(object, properties, indent, prefix) {
			if (!ArrayBuffer.isView(object)) {
				...
				for (key in object) if (hasOwnProperty.call(object, key) && "_" !== key[0] && (addedProperties++, addValueToProperties(key, object[key], properties, indent, prefix), 100 <= addedProperties)) {
					properties.push([prefix + "\xA0\xA0".repeat(indent) + "Only 100 properties are shown. React will not log more properties of this object.", ""]);
					break;
				}
			}
		}
		...
		function addObjectDiffToProperties(prev, next, properties, indent) {
			...
			for (key in prev) {
				if (100 < prevPropertiesChecked) {
					properties.push(["Previous object has more than 100 properties. React will not attempt to diff objects with too many properties.", ""]);
					isDeeplyEqual = !1;
					break;
				}
				key in next || (properties.push(["-\xA0" + "\xA0\xA0".repeat(indent) + key, "…"]), isDeeplyEqual = !1);
				prevPropertiesChecked++;
			}
			prevPropertiesChecked = 0;
			for (var _key in next) {
				if (100 < prevPropertiesChecked) {
					properties.push(["Next object has more than 100 properties. React will not attempt to diff objects with too many properties.", ""]);
					isDeeplyEqual = !1;
					break;
				}
				if (_key in prev) {
					...
					if (key !== nextValue) {
						if (0 === indent && "children" === _key) {
							...
							properties.push(["-\xA0" + isDeeplyEqual, "…"], ["+\xA0" + isDeeplyEqual, "…"]);
							isDeeplyEqual = !1;
							continue;
						}
						if (!(3 <= indent)) {
		...
		function logCommitPhase(startTime, endTime, errors, abortedViewTransition, debugTask) {
			null !== errors ? logCommitErrored(startTime, endTime, errors, !1, debugTask) : !supportsUserTiming || endTime <= startTime || (debugTask ? debugTask.run(console.timeStamp.bind(console, abortedViewTransition ? "Commit Interrupted View Transition" : "Commit", startTime, endTime, currentTrack, "Scheduler ⚛", abortedViewTransition ? "error" : "secondary-dark")) : console.timeStamp(abortedViewTransition ? "Commit Interrupted View Transition" : "Commit", startTime, endTime, currentTrack, "Scheduler ⚛", abortedViewTransition ? "error" : "secondary-dark"));
		}
		function logAnimatingPhase(startTime, endTime, debugTask) {
			!supportsUserTiming || endTime <= startTime || (debugTask ? debugTask.run(console.timeStamp.bind(console, "Animating", startTime, endTime, currentTrack, "Scheduler ⚛", "secondary-dark")) : console.timeStamp("Animating", startTime, endTime, currentTrack, "Scheduler ⚛", "secondary-dark"));
		}
		...
		function pushHostContext(fiber) {
			...
			null !== stateHook && (stateHook = stateHook.memoizedState, isPrimaryRenderer ? HostTransitionContext._currentValue = stateHook : HostTransitionContext._currentValue2 = stateHook, push(hostTransitionProviderCursor, fiber, fiber));
		...
		function bailoutHooks(current, workInProgress, lanes) {
			...
			workInProgress.flags = (workInProgress.mode & 16) !== NoMode ? workInProgress.flags & -805308421 : workInProgress.flags & -2053;
			current.lanes &= ~lanes;
		}
		...
		function mountEffect(create, deps) {
			(currentlyRenderingFiber.mode & 16) !== NoMode ? mountEffectImpl(545261568, Passive, create, deps) : mountEffectImpl(8390656, Passive, create, deps);
		}
		...
		function mountLayoutEffect(create, deps) {
			...
			(currentlyRenderingFiber.mode & 16) !== NoMode && (fiberFlags |= 268435456);
		...
		function updateClassComponent(current, workInProgress, Component, nextProps, renderLanes) {
			...
			if (null === workInProgress.stateNode) {
				...
				(workInProgress.mode & 16) !== NoMode && (workInProgress.flags |= 268435456);
				_instance = !0;
				...
				unresolvedOldProps || oldState !== oldContext || hasForceUpdate ? ("function" === typeof newApiName && (applyDerivedStateFromProps(workInProgress, Component, newApiName, nextProps), oldContext = workInProgress.memoizedState), (lane = hasForceUpdate || checkShouldComponentUpdate(workInProgress, Component, lane, nextProps, oldState, oldContext, state)) ? (foundWillUpdateName || "function" !== typeof _instance.UNSAFE_componentWillMount && "function" !== typeof _instance.componentWillMount || ("function" === typeof _instance.componentWillMount && _instance.componentWillMount(), "function" === typeof _instance.UNSAFE_componentWillMount && _instance.UNSAFE_componentWillMount()), "function" === typeof _instance.componentDidMount && (workInProgress.flags |= 4194308), (workInProgress.mode & 16) !== NoMode && (workInProgress.flags |= 268435456)) : ("function" === typeof _instance.componentDidMount && (workInProgress.flags |= 4194308), (workInProgress.mode & 16) !== NoMode && (workInProgress.flags |= 268435456), workInProgress.memoizedProps = nextProps, workInProgress.memoizedState = oldContext), _instance.props = nextProps, _instance.state = oldContext, _instance.context = state, _instance = lane) : ("function" === typeof _instance.componentDidMount && (workInProgress.flags |= 4194308), (workInProgress.mode & 16) !== NoMode && (workInProgress.flags |= 268435456), _instance = !1);
			} else {
				_instance = workInProgress.stateNode;
		...
		function updateSuspenseComponent(current, workInProgress, renderLanes) {
			...
			if (showFallback) return reuseSuspenseHandlerOnStack(workInProgress), showFallback = nextProps.fallback, didSuspend = workInProgress.mode, prevState = current.child, _dehydrated2 = prevState.sibling, nextProps = createWorkInProgress(prevState, {
				mode: "hidden",
				children: nextProps.children
			}), nextProps.subtreeFlags = prevState.subtreeFlags & 1206910976, null !== _dehydrated2 ? showFallback = createWorkInProgress(_dehydrated2, showFallback) : (showFallback = createFiberFromFragment(showFallback, didSuspend, renderLanes, null), showFallback.flags |= 2), showFallback.return = workInProgress, nextProps.return = workInProgress, nextProps.sibling = showFallback, workInProgress.child = nextProps, bailoutOffscreenComponent(null, nextProps), nextProps = workInProgress.child, showFallback = current.child.memoizedState, null === showFallback ? showFallback = mountSuspenseOffscreenState(renderLanes) : (didSuspend = showFallback.cachePool, null !== didSuspend ? (prevState = isPrimaryRenderer ? CacheContext._currentValue : CacheContext._currentValue2, didSuspend = didSuspend.parent !== prevState ? {
				parent: prevState,
				pool: prevState
		...
		function updateDehydratedSuspenseComponent(current, workInProgress, didSuspend, didPrimaryChildrenDefer, nextProps, suspenseInstance, suspenseState, renderLanes) {
			...
			if (isSuspenseInstanceFallback(suspenseInstance)) return suspenseState = getSuspenseInstanceFallbackErrorDetails(suspenseInstance), didPrimaryChildrenDefer = suspenseState.digest, suspenseInstance = suspenseState.message, nextProps = suspenseState.stack, suspenseState = suspenseState.componentStack, didPrimaryChildrenDefer !== REACT_RECOVERABLE_DIGEST && (suspenseInstance = suspenseInstance ? Error(suspenseInstance) : Error("The server could not finish this Suspense boundary, likely due to an error during server rendering. Switched to client rendering."), suspenseInstance.stack = nextProps || "", suspenseInstance.digest = didPrimaryChildrenDefer, didPrimaryChildrenDefer = void 0 === suspenseState ? null : suspenseState, nextProps = {
				value: suspenseInstance,
				source: null,
				stack: didPrimaryChildrenDefer
			}, "string" === typeof didPrimaryChildrenDefer && CapturedStacks.set(suspenseInstance, nextProps), queueHydrationError(nextProps)), retrySuspenseComponentWithoutHydrating(current, workInProgress, renderLanes);
			...
			supportsHydration && (nextHydratableInstance = getFirstHydratableChildWithinSuspenseInstance(suspenseInstance), hydrationParentFiber = workInProgress, isHydrating = !0, hydrationErrors = null, didSuspendOrErrorDEV = !1, hydrationDiffRootDEV = null, rootOrSingletonContext = !1, null !== current && restoreSuspendedTreeContext(workInProgress, current));
		...
		function completeWork(current, workInProgress, renderLanes) {
			...
			switch (workInProgress.tag) {
				...
				case 13:
					...
					return null;
				case 4: return popHostContainer(workInProgress), updateHostContainer(current, workInProgress), null === current && preparePortalMount(workInProgress.stateNode.containerInfo), workInProgress.flags |= 67108864, bubbleProperties(workInProgress), null;
			...
			if (null !== ref) {
				switch (finishedWork.tag) {
					...
					case 30:
						...
						break;
					case 7:
						null === finishedWork.stateNode && (finishedWork.stateNode = createFragmentInstance(finishedWork));
						instanceToUse = finishedWork.stateNode;
						break;
		...
		function isFragmentInstanceHostBoundary(fiber) {
			return 5 === fiber.tag || 3 === fiber.tag || (supportsSingletons ? 27 === fiber.tag : !1);
		}
		...
		function insertOrAppendPlacementNodeIntoContainer(node, before, parent, parentFragmentInstances) {
			var tag = node.tag;
			if (5 === tag || 6 === tag) tag = node.stateNode, before ? insertInContainerBefore(parent, tag, before) : appendChildToContainer(parent, tag), commitNewChildToFragmentInstances(node, parentFragmentInstances), viewTransitionMutationContext = !0;
			else if (4 !== tag && (supportsSingletons && 27 === tag && (commitNewChildToFragmentInstances(node, parentFragmentInstances), parentFragmentInstances = null, isSingletonScope(node.type) && (parent = node.stateNode, before = null)), node = node.child, null !== node)) for (insertOrAppendPlacementNodeIntoContainer(node, before, parent, parentFragmentInstances), node = node.sibling; null !== node;) insertOrAppendPlacementNodeIntoContainer(node, before, parent, parentFragmentInstances), node = node.sibling;
		}
		function insertOrAppendPlacementNode(node, before, parent, parentFragmentInstances) {
			var tag = node.tag;
			if (5 === tag || 6 === tag) tag = node.stateNode, before ? insertBefore(parent, tag, before) : appendChild(parent, tag), commitNewChildToFragmentInstances(node, parentFragmentInstances), viewTransitionMutationContext = !0;
		...
		function commitPlacement(finishedWork) {
			...
			} else commitImmutablePlacementNodeToFragmentInstances(finishedWork, parentFiber);
		}
		function commitImmutablePlacementNodeToFragmentInstances(finishedWork, parentFragmentInstances) {
			if (5 === finishedWork.tag || supportsSingletons && 27 === finishedWork.tag) commitNewChildToFragmentInstances(finishedWork, parentFragmentInstances);
			else if (4 !== finishedWork.tag && (finishedWork = finishedWork.child, null !== finishedWork)) for (commitImmutablePlacementNodeToFragmentInstances(finishedWork, parentFragmentInstances), finishedWork = finishedWork.sibling; null !== finishedWork;) commitImmutablePlacementNodeToFragmentInstances(finishedWork, parentFragmentInstances), finishedWork = finishedWork.sibling;
		}
		...
		function applyViewTransitionToHostInstancesRecursive(child, name, className, collectMeasurements, stopAtNestedViewTransitions) {
			...
			for (var inViewport = !1; null !== child;) {
				if (5 === child.tag) {
					...
					} else inViewport || wasInstanceInViewport(measureInstance(_instance)) && (inViewport = !0);
		...
		function restoreViewTransitionOnHostInstances(child, stopAtNestedViewTransitions) {
			if (supportsMutation) for (; null !== child;) {
			...
			for (var inViewport = !1; null !== child;) {
				if (5 === child.tag) {
					...
					if (null !== previousMeasurements && viewTransitionHostInstanceIdx < previousMeasurements.length) {
						...
						if (wasInstanceInViewport(previousMeasurement) || wasInstanceInViewport(nextMeasurement)) inViewport = !0;
		...
		function commitBeforeMutationEffects(root, firstChild, committedLanes) {
			...
			for (firstChild = root ? 9270 : 1024; null !== nextEffect;) {
				...
				if (root) {
					...
					if (null !== deletions) for (var i = 0; i < deletions.length; i++) root && commitExitViewTransitions(deletions[i]);
				}
				if (null === committedLanes.alternate && 0 !== (committedLanes.flags & 2)) root && trackEnterViewTransitions(committedLanes), commitBeforeMutationEffects_complete(root);
				else {
			...
			for (; null !== nextEffect;) {
				...
				switch (finishedWork.tag) {
					...
					case 1:
						...
						break;
					case 3:
						0 !== (flags & 1024) && supportsMutation && clearContainer(finishedWork.stateNode.containerInfo);
						break;
					case 5:
					case 26:
					case 27:
			...
			switch (finishedWork.tag) {
				...
				case 22:
					...
					if (!flags) {
						...
						(offscreenSubtreeWasHidden = newOffscreenSubtreeWasHidden) && !prevProps ? (flags = supportsSingletons ? IncludeHostSingletons : NoLayoutEffectTraversalFlags, 0 !== (finishedWork.subtreeFlags & 8772) && (flags |= IncludeWorkInProgressEffects), recursivelyTraverseReappearLayoutEffects(finishedRoot, finishedWork, flags), (finishedWork.mode & 2) !== NoMode && 0 <= componentEffectStartTime && 0 <= componentEffectEndTime && .05 < componentEffectEndTime - componentEffectStartTime && logComponentReappeared(finishedWork, componentEffectStartTime, componentEffectEndTime)) : recursivelyTraverseLayoutEffects(finishedRoot, finishedWork);
		...
		function hideOrUnhideAllChildren(parentFiber, isHidden) {
			if (supportsMutation) for (parentFiber = parentFiber.child; null !== parentFiber;) hideOrUnhideAllChildrenOnFiber(parentFiber, isHidden), parentFiber = parentFiber.sibling;
		}
		function hideOrUnhideAllChildrenOnFiber(fiber, isHidden) {
			if (supportsMutation) switch (fiber.tag) {
				case 5:
				case 26:
					try {
		...
		function hideOrUnhideNearestPortals(parentFiber, isHidden$jscomp$0) {
			if (supportsMutation && parentFiber.subtreeFlags & 67108864) for (parentFiber = parentFiber.child; null !== parentFiber;) {
		...
		function commitMutationEffectsOnFiber(finishedWork, root, lanes) {
			...
			switch (finishedWork.tag) {
				...
				case 1:
					...
					flags & 64 && offscreenSubtreeIsHidden && (root = finishedWork.updateQueue, null !== root && (flags = root.callbacks, null !== flags && (lanes = root.shared.hiddenCallbacks, root.shared.hiddenCallbacks = null === lanes ? flags : lanes.concat(flags))));
					break;
				case 26: if (supportsResources) {
					...
					commitReconciliationEffects(finishedWork);
					flags & 512 && (offscreenSubtreeWasHidden || null === current || safelyDetachRef(current, current.return));
					flags & 4 && (lanes = null !== current ? current.memoizedState : null, flags = finishedWork.memoizedState, null === current ? null === flags ? null === finishedWork.stateNode ? finishedWork.stateNode = offscreenSubtreeIsHidden ? createHoistableInstance(finishedWork.type, finishedWork.memoizedProps, root.containerInfo, finishedWork) : hydrateHoistable(ii, finishedWork.type, finishedWork.memoizedProps, finishedWork) : offscreenSubtreeIsHidden || mountHoistable(ii, finishedWork.type, finishedWork.stateNode) : finishedWork.stateNode = acquireResource(ii, flags, finishedWork.memoizedProps) : lanes !== flags ? (null === lanes ? (root = current.stateNode, null === root || offscreenSubtreeWasHidden || unmountHoistable(root)) : releaseResource(lanes), null === flags ? offscreenSubtreeIsHidden || mountHoistable(ii, finishedWork.type, finishedWork.stateNode) : acquireResource(ii, flags, finishedWork.memoizedProps)) : null === flags && null !== finishedWork.stateNode && commitHostUpdate(finishedWork, finishedWork.memoizedProps, current.memoizedProps));
					break;
				}
				case 27: if (supportsSingletons) {
					recursivelyTraverseMutationEffects(root, finishedWork, lanes);
				...
				case 6:
					...
					if (flags & 4 && supportsMutation) {
						...
						try {
							runWithFiberInDEV(finishedWork, commitTextUpdate, lanes, flags, root), viewTransitionMutationContext = !0;
						} catch (error) {
							captureCommitPhaseError(finishedWork, finishedWork.return, error);
						}
					}
				...
				case 3:
					...
					viewTransitionMutationContext = !1;
					supportsResources ? (prepareToCommitHoistables(), _eventPayloads$ii2 = currentHoistableRoot, currentHoistableRoot = getHoistableRoot(root.containerInfo), recursivelyTraverseMutationEffects(root, finishedWork, lanes), currentHoistableRoot = _eventPayloads$ii2) : recursivelyTraverseMutationEffects(root, finishedWork, lanes);
					commitReconciliationEffects(finishedWork);
					if (flags & 4) {
						...
						if (supportsPersistence) {
							...
							try {
								runWithFiberInDEV(finishedWork, replaceContainerChildren, flags, lanes), viewTransitionMutationContext = !0;
							} catch (error) {
								captureCommitPhaseError(finishedWork, finishedWork.return, error);
							}
						}
				...
				case 4:
					...
					supportsResources ? (_eventPayloads$ii2 = currentHoistableRoot, currentHoistableRoot = getHoistableRoot(finishedWork.stateNode.containerInfo), recursivelyTraverseMutationEffects(root, finishedWork, lanes), commitReconciliationEffects(finishedWork), currentHoistableRoot = _eventPayloads$ii2) : (recursivelyTraverseMutationEffects(root, finishedWork, lanes), commitReconciliationEffects(finishedWork));
				...
				case 22:
					...
					_eventPayloads$ii2 && !ii && !prevOffscreenSubtreeIsHidden && !prevOffscreenSubtreeWasHidden && (finishedWork.mode & 2) !== NoMode && 0 <= componentEffectStartTime && 0 <= componentEffectEndTime && .05 < componentEffectEndTime - componentEffectStartTime && logComponentReappeared(finishedWork, componentEffectStartTime, componentEffectEndTime);
					commitReconciliationEffects(finishedWork);
					flags & 8192 && (root = finishedWork.stateNode, root._visibility = ii ? root._visibility & ~OffscreenVisible : root._visibility | OffscreenVisible, !ii || null === current || _eventPayloads$ii2 || offscreenSubtreeIsHidden || offscreenSubtreeWasHidden || (root = supportsSingletons ? IncludeHostSingletons : NoLayoutEffectTraversalFlags, lanes = _eventPayloads$ii2 || offscreenSubtreeWasHidden, current = offscreenSubtreeIsHidden, _eventPayloads$ii2 = offscreenSubtreeWasHidden, offscreenSubtreeIsHidden = ii || offscreenSubtreeIsHidden, offscreenSubtreeWasHidden = lanes, recursivelyTraverseDisappearLayoutEffects(finishedWork, root), (finishedWork.mode & 2) !== NoMode && 0 <= componentEffectStartTime && 0 <= componentEffectEndTime && .05 < componentEffectEndTime - componentEffectStartTime && logComponentTrigger(finishedWork, componentEffectStartTime, componentEffectEndTime, "Disconnect"), offscreenSubtreeIsHidden = current, offscreenSubtreeWasHidden = _eventPayloads$ii2), supportsMutation && (ii || !offscreenDirectParentIsHidden) && hideOrUnhideAllChildren(finishedWork, ii));
				...
				case 30:
					...
					break;
				case 21: break;
				case 7: flags & 512 && (offscreenSubtreeWasHidden || null === current || safelyDetachRef(current, current.return)), current && null !== current.stateNode && updateFragmentInstanceFiber(finishedWork, current.stateNode);
			...
			if (null === current) commitEnterViewTransitions(finishedWork, !1);
				...
				case 3:
					...
					if (!viewTransitionContextChanged && !rootViewTransitionAffected) {
						...
						if (null !== finishedWork) for (var i = 0; i < finishedWork.length; i += 3) cancelViewTransitionName(finishedWork[i], finishedWork[i + 1], finishedWork[i + 2]);
				...
				case 30:
					...
					"none" === className ? current = !1 : (props = current.memoizedState, current.memoizedState = null, current = finishedWork.child, viewTransitionHostInstanceIdx = 0, current = measureViewTransitionHostInstancesRecursive(finishedWork, current, root, state, className, props, !0), viewTransitionHostInstanceIdx !== (null === props ? 0 : props.length) && (finishedWork.flags |= 32));
					0 !== (finishedWork.flags & 4) && current ? (scheduleViewTransitionEvent(finishedWork, finishedWork.memoizedProps.onUpdate), viewTransitionCancelableChildren = prevCancelableChildren) : null !== prevCancelableChildren && (prevCancelableChildren.push.apply(prevCancelableChildren, viewTransitionCancelableChildren), viewTransitionCancelableChildren = prevCancelableChildren);
		...
		function disappearLayoutEffects(finishedWork, layoutEffectTraversalFlags) {
			...
			switch (finishedWork.tag) {
				...
				case 1:
					...
					recursivelyTraverseDisappearLayoutEffects(finishedWork, layoutEffectTraversalFlags);
					break;
				case 27: supportsSingletons && (layoutEffectTraversalFlags & IncludeHostSingletons) !== NoLayoutEffectTraversalFlags && runWithFiberInDEV(finishedWork, releaseSingletonInstance, finishedWork.stateNode, finishedWork.type, finishedWork.memoizedProps);
				case 5:
					safelyDetachRef(finishedWork, finishedWork.return);
		...
		function reappearLayoutEffects(finishedRoot, current, finishedWork, layoutEffectTraversalFlags) {
			...
			switch (finishedWork.tag) {
				...
				case 1:
					...
					break;
				case 27: supportsSingletons && (layoutEffectTraversalFlags & IncludeHostSingletons) !== NoLayoutEffectTraversalFlags && commitHostSingletonAcquisition(finishedWork);
				case 5:
		...
		function commitPassiveMountOnFiber(finishedRoot, finishedWork, committedLanes, committedTransitions, endTime) {
			...
			switch (finishedWork.tag) {
				...
				case 31:
					...
					isViewTransitionEligible = null !== finishedWork.alternate ? finishedWork.alternate.memoizedState : null;
				...
				case 13:
					...
					isViewTransitionEligible = null !== finishedWork.alternate ? finishedWork.alternate.memoizedState : null;
					prevProfilerEffectDuration = finishedWork.memoizedState;
					null === isViewTransitionEligible || null === isViewTransitionEligible.dehydrated || null !== prevProfilerEffectDuration && null !== prevProfilerEffectDuration.dehydrated ? inHydratedSubtree = !1 : (prevProfilerEffectDuration = finishedWork.deletions, null !== prevProfilerEffectDuration && 0 < prevProfilerEffectDuration.length && 18 === prevProfilerEffectDuration[0].tag ? (inHydratedSubtree = !1, isViewTransitionEligible = isViewTransitionEligible.hydrationErrors, null !== isViewTransitionEligible && logComponentErrored(finishedWork, finishedWork.actualStartTime, endTime, isViewTransitionEligible)) : inHydratedSubtree = !0);
					recursivelyTraversePassiveMountEffects(finishedRoot, finishedWork, committedLanes, committedTransitions, endTime);
					inHydratedSubtree = flags;
					break;
				case 23: break;
				case 22:
					...
					null !== finishedWork.memoizedState ? (isViewTransitionEligible && null !== prevProfilerEffectDuration && null === prevProfilerEffectDuration.memoizedState && restoreEnterOrExitViewTransitions(prevProfilerEffectDuration), wasInHydratedSubtree._visibility & OffscreenPassiveEffectsConnected ? recursivelyTraversePassiveMountEffects(finishedRoot, finishedWork, committedLanes, committedTransitions, endTime) : recursivelyTraverseAtomicPassiveEffects(finishedRoot, finishedWork, committedLanes, committedTransitions, endTime)) : (isViewTransitionEligible && null !== prevProfilerEffectDuration && null !== prevProfilerEffectDuration.memoizedState && restoreEnterOrExitViewTransitions(finishedWork), wasInHydratedSubtree._visibility & OffscreenPassiveEffectsConnected ? recursivelyTraversePassiveMountEffects(finishedRoot, finishedWork, committedLanes, committedTransitions, endTime) : (wasInHydratedSubtree._visibility |= OffscreenPassiveEffectsConnected, recursivelyTraverseReconnectPassiveEffects(finishedRoot, finishedWork, committedLanes, committedTransitions, 0 !== (finishedWork.subtreeFlags & 10256) || 0 !== finishedWork.actualDuration && (null === finishedWork.alternate || finishedWork.alternate.child !== finishedWork.child), endTime), (finishedWork.mode & 2) === NoMode || inHydratedSubtree || (finishedRoot = finishedWork.actualStartTime, 0 <= finishedRoot && .05 < endTime - finishedRoot && logComponentReappeared(finishedWork, finishedRoot, endTime), 0 <= componentEffectStartTime && 0 <= componentEffectEndTime && .05 < componentEffectEndTime - componentEffectStartTime && logComponentReappeared(finishedWork, componentEffectStartTime, componentEffectEndTime))));
		...
		function requestUpdateLane(fiber) {
			...
			if (null !== transition) return transition._updatedFibers || (transition._updatedFibers = /* @__PURE__ */ new Set()), transition._updatedFibers.add(fiber), null !== lastSuspendedFiber && 2 === resolveUpdatePriority() && (lastSuspendedFiber = null), requestTransitionLane();
		...
		function replayBeginWork(unitOfWork) {
			...
			switch (unitOfWork.tag) {
				...
				case 5:
					...
					supportsHydration && fiber === hydrationParentFiber && (isHydrating ? (popToNextHostParent(fiber), 5 === fiber.tag && null != fiber.stateNode && (nextHydratableInstance = fiber.stateNode)) : (popToNextHostParent(fiber), isHydrating = !0));
		...
		function commitRoot(root, finishedWork, lanes, spawnedLane, updatedLanes, suspendedRetryLanes, suspendedState, suspendedCommitReason, completedRenderEndTime) {
			...
			0 !== finishedWork.actualDuration || 0 !== (finishedWork.subtreeFlags & spawnedLane) || 0 !== (finishedWork.flags & spawnedLane) ? (root.callbackNode = null, root.callbackPriority = 0, scheduleCallback(NormalPriority$1, function() {
				trackSchedulerEvent();
				pendingDelayedCommitReason === IMMEDIATE_COMMIT && (pendingDelayedCommitReason = DELAYED_PASSIVE_COMMIT);
				flushPassiveEffects();
				return null;
			...
			if (0 !== (finishedWork.subtreeFlags & 13878) || suspendedCommitReason) {
				...
				try {
					...
					executionContext = spawnedLane, setCurrentUpdatePriority(completedRenderEndTime), ReactSharedInternals.T = suspendedCommitReason;
				}
			}
		...
		function flushMutationEffects() {
			if (pendingEffectsStatus === PENDING_MUTATION_PHASE) {
				...
				if (0 !== (finishedWork.subtreeFlags & 13878) || rootMutationHasEffect) {
					...
					executionContext |= CommitContext;
					try {
						inProgressLanes = lanes, inProgressRoot = root, inUpdateViewTransition = rootViewTransitionAffected = !1, resetComponentEffectTimers(), commitMutationEffectsOnFiber(finishedWork, root, lanes), inProgressRoot = inProgressLanes = null, resetAfterCommit(root.containerInfo);
					} finally {
		...
		function flushSpawnedWork() {
			if (pendingEffectsStatus === PENDING_SPAWNED_WORK || pendingEffectsStatus === PENDING_AFTER_MUTATION_PHASE) {
				...
				if (null !== onRecoverableError && (pendingViewTransitionEvents = null, null === recoverableError && (recoverableError = []), null !== startViewTransitionStartTime)) for (errorInfo = 0; errorInfo < onRecoverableError.length; errorInfo++) recoverableErrors = (0, onRecoverableError[errorInfo])(recoverableError), void 0 !== recoverableErrors && addViewTransitionFinishedListener(startViewTransitionStartTime, recoverableErrors);
		...
		function createFiberFromTypeAndProps(type, key, pendingProps, owner, mode, lanes) {
			...
			if ("function" === typeof resolvedType) shouldConstruct(resolvedType) && (fiberTag = 1);
				...
				case REACT_VIEW_TRANSITION_TYPE: return type = mode | 32, key = createFiber(30, pendingProps, key, type), key.elementType = REACT_VIEW_TRANSITION_TYPE, key.lanes = lanes, key.stateNode = {
					autoName: null,
					paired: null,
					clones: null,
					ref: null
		...
		}, reusableChangedPropsEntry = ["Changed Props", ""], reusableDeeplyEqualPropsEntry = ["Changed Props", "This component received deeply equal props. It might benefit from useMemo or the React Compiler in its owner."], disabledDepth = 0, prevLog, prevInfo, prevWarn, prevError, prevGroup, prevGroupCollapsed, prevGroupEnd;
		...
		var currentlyRenderingFiber$1 = null, lastContextDependency = null, isDisallowedContextReadInDEV = !1, AbortControllerLocal = "undefined" !== typeof AbortController ? AbortController : function() {
			...
			return null;
		}, renderStartTime = -0, commitStartTime = -0, commitEndTime = -0, commitErrors = null, profilerStartTime = -1.1, profilerEffectDuration = -0, componentEffectDuration = -0, componentEffectStartTime = -1.1, componentEffectEndTime = -1.1, componentEffectErrors = null, componentEffectSpawnedUpdate = !1, blockingClampTime = -0, blockingUpdateTime = -1.1, blockingUpdateTask = null, blockingUpdateType = 0, blockingUpdateMethodName = null, blockingUpdateComponentName = null, blockingEventTime = -1.1, blockingEventType = null, blockingEventRepeatTime = -1.1, blockingSuspendedTime = -1.1, transitionClampTime = -0, transitionStartTime = -1.1, transitionUpdateTime = -1.1, transitionUpdateType = 0, transitionUpdateTask = null, transitionUpdateMethodName = null, transitionUpdateComponentName = null, transitionEventTime = -1.1, transitionEventType = null, transitionEventRepeatTime = -1.1, transitionSuspendedTime = -1.1, retryClampTime = -0, idleClampTime = -0, animatingLanes = 0, animatingTask = null, yieldReason = 0, yieldStartTime = -1.1, currentUpdateIsNested = !1, nestedUpdateScheduled = !1, firstScheduledRoot = null, lastScheduledRoot = null, didScheduleMicrotask = !1, didScheduleMicrotask_act = !1, mightHavePendingSyncWork = !1, isFlushingWork = !1, currentEventTransitionLane = 0, fakeActCallbackNode$1 = {}, currentEntangledListeners = null, currentEntangledPendingCount = 0, currentEntangledLane = 0, currentEntangledActionThenable = null, prevOnStartTransitionFinish = ReactSharedInternals.S;
...
//#endregion
//#region node_modules/react-konva/es/EventBatch.js
var import_scheduler = require_scheduler();
var pending = /* @__PURE__ */ new Set();
var pendingUnmounts = /* @__PURE__ */ new Set();
var enqueue = typeof queueMicrotask === "function" ? queueMicrotask : (callback) => Promise.resolve().then(callback);
var depth = 0;
var batches = /* @__PURE__ */ new WeakMap();
...
function batchEvents(callback) {
	...
	try {
		...
		try {
			while (pending.size) (0, import_react_dom.flushSync)(() => {
...
var ReactKonvaHostConfig_exports = /* @__PURE__ */ __exportAll({
	...
	commitNewChildToFragmentInstance: () => commitNewChildToFragmentInstance,
	commitTextUpdate: () => commitTextUpdate,
	commitUpdate: () => commitUpdate,
	createFragmentInstance: () => createFragmentInstance,
	createInstance: () => createInstance,
	createTextInstance: () => createTextInstance,
	createViewTransitionInstance: () => createViewTransitionInstance,
	deleteChildFromFragmentInstance: () => deleteChildFromFragmentInstance,
	...
	updateFragmentInstanceFiber: () => updateFragmentInstanceFiber,
...
function updateFragmentInstanceFiber() {}
function commitNewChildToFragmentInstance() {}
function deleteChildFromFragmentInstance() {}
...
function maySuspendCommit() {
	throw new Error("ViewTransition is not supported inside a Stage. Place ViewTransition around Stage to animate its DOM container.");
}
var createViewTransitionInstance = maySuspendCommit;
...
var NotPendingTransition = Object.freeze({
	pending: false,
	data: null,
	method: null,
	action: null
});
var HostTransitionContext = /* @__PURE__ */ import_react.createContext(NotPendingTransition);
...
* MIT
*/
var [reactMajor, reactMinor] = "19.3.0".split(".").map(Number);
if (reactMajor !== 19 || reactMinor < 3) throw new Error("react-konva requires React 19.3 or later within React 19. Install matching versions of react and react-dom. For React 19.2, use react-konva 19.2. For React 18, use react-konva 18.");
...
var StageWrap = (props) => {
	...
	const children = import_react.useRef(null);
	const suspension = import_react.useRef(null);
	const identifierPrefix = import_react.useId();
	const formStatus = (0, import_react_dom.useFormStatus)();
	const previousProps = import_react.useRef({});
	const oldProps = previousProps.current;
	const Bridge = x();
	const isStrictMode = !!i(c(), true, (node) => node.type === import_react.StrictMode);
	const effectsDisconnected = import_react.useRef(false);
	const isUnmounting = import_react.useRef(false);
	const cancelUnmount = import_react.useRef(null);
	...
	const setCanvasVisibility = (mode) => {
		...
		KonvaRenderer.updateContainer(import_react.createElement(import_react.Activity, {
			mode: mode === "hidden" ? "hidden" : "visible",
			children: import_react.createElement(import_react.Suspense, { fallback: null }, children.current, suspension.current && import_react.createElement(SuspendCanvas, { promise: suspension.current.promise }))
	...
	import_react.useLayoutEffect(() => {
		...
		if (!stage.current) {
			...
			fiberRef.current = KonvaRenderer.createContainer(stage.current, import_constants.ConcurrentRoot, null, isStrictMode, null, identifierPrefix, console.error, console.error, console.error, null);
		}
		return () => {
	...
	import_react.useLayoutEffect(() => {
		if (typeof stage.current.eventBatchFunc === "function") stage.current.eventBatchFunc(getEventBatch(props.eventBatchFunc));
	}, [props.eventBatchFunc]);
	import_react.useImperativeHandle(props.forwardedRef, () => stage.current, []);
	import_react.useLayoutEffect(() => {
		previousProps.current = props;
		applyNodeProps(stage.current, props, oldProps);
		children.current = import_react.createElement(HostTransitionContext.Provider, { value: formStatus }, import_react.createElement(Bridge, {}, props.children));
...
var version = "19.3.0";
var rendererConfig = {
	...ReactKonvaHostConfig_exports,
	rendererVersion: version,
	rendererPackageName: "react-konva"
};
var KonvaRenderer = (0, import_react_reconciler.default)(rendererConfig);
