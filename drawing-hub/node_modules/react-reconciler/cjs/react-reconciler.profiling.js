...
module.exports = function ($$$config) {
  ...
  function startUpdateTimerByLane(lane) {
    if (0 !== (lane & 127)) {
      if (0 > blockingUpdateTime) {
        ...
        var newEventType$20 = resolveEventType();
        lane !== blockingEventRepeatTime ||
        newEventType$20 !== blockingEventType
          ? (blockingEventRepeatTime = -1.1)
          : null !== newEventType$20 && (blockingUpdateType = 1);
        blockingEventTime = lane;
        blockingEventType = newEventType$20;
      }
    } else if (
      0 !== (lane & 4194048) &&
      ...
      lane = resolveEventTimeStamp();
      newEventType$20 = resolveEventType();
      if (
        lane !== transitionEventRepeatTime ||
        newEventType$20 !== transitionEventType
      )
        transitionEventRepeatTime = -1.1;
      transitionEventTime = lane;
      transitionEventType = newEventType$20;
    }
  }
  ...
  function updateSuspenseComponent(current, workInProgress, renderLanes) {
    ...
    var prevState = current.memoizedState;
    if (null !== prevState) {
      var dehydrated$84 = prevState.dehydrated;
      if (null !== dehydrated$84)
    ...
    if (showFallback)
      return (
        ...
        (dehydrated$84 = prevState.sibling),
        ...
        null !== dehydrated$84
          ? (showFallback = createWorkInProgress(dehydrated$84, showFallback))
      ...
      if (0 !== (completedWork.mode & 2)) {
        for (
          ...
          (newChildLanes |= child$107.lanes | child$107.childLanes),
            (subtreeFlags |= child$107.subtreeFlags & 1206910976),
            (subtreeFlags |= child$107.flags & 1206910976),
        ...
        for (
          ...
          (newChildLanes |=
            ...
            (subtreeFlags |= treeBaseDuration$106.subtreeFlags & 1206910976),
            (subtreeFlags |= treeBaseDuration$106.flags & 1206910976),
    ...
    switch (finishedWork.tag) {
      ...
      case 6:
        ...
        if (flags & 4 && supportsMutation) {
          ...
          try {
            commitTextUpdate(lanes, flags, root),
              (viewTransitionMutationContext = !0);
          } catch (error) {
            captureCommitPhaseError(finishedWork, finishedWork.return, error);
          }
      ...
      case 3:
        ...
        if (flags & 4) {
          ...
          if (supportsPersistence) {
            ...
            try {
              replaceContainerChildren(flags, lanes),
                (viewTransitionMutationContext = !0);
            } catch (error) {
              captureCommitPhaseError(finishedWork, finishedWork.return, error);
            }
      ...
      case 22:
        ...
        offscreenDirectParentIsHidden =
          prevOffscreenDirectParentIsHidden$171 || ii;
        offscreenSubtreeWasHidden =
          ...
          switch (hostParentFiber.tag) {
            ...
            case 5:
              ...
              hostParentFiber.flags & 32 &&
                (resetTextContent(parent$151), (hostParentFiber.flags &= -33));
    ...
    if (0 !== (lanes & 127)) {
      ...
      endTime =
        0 <= blockingEventTime && blockingEventTime < blockingClampTime
          ? blockingClampTime
          : blockingEventTime;
      var clampedRenderStartTime$207 =
        0 <= endTime
          ? endTime
      ...
      0 <= blockingSuspendedTime
        ? (setCurrentTrackFromLanes(2),
          logSuspendedWithDelayPhase(
            ...
            clampedRenderStartTime$207,
            lanes
          ))
        : 0 !== (animatingLanes & 127) &&
          (setCurrentTrackFromLanes(2),
          logAnimatingPhase(blockingClampTime, clampedRenderStartTime$207));
      clampedRenderStartTime$207 = blockingEventType;
      ...
      supportsUserTiming &&
        ...
        0 < endTime
          ? endTime > previousRenderStartTime &&
            (endTime = previousRenderStartTime)
          : (endTime = previousRenderStartTime),
        null !== clampedRenderStartTime$207 &&
          previousRenderStartTime > endTime &&
          console.timeStamp(
            eventIsRepeat
              ? "Consecutive"
              : "Event: " + clampedRenderStartTime$207,
            endTime,
            previousRenderStartTime,
            currentTrack,
            "Scheduler \u269b",
    ...
    0 !== (lanes & 4194048) &&
      ...
      supportsUserTiming &&
        ...
        0 < previousRenderStartTime
          ...
          : (previousRenderStartTime = endTime),
        0 < clampedRenderStartTime$207
          ? clampedRenderStartTime$207 > previousRenderStartTime &&
            (clampedRenderStartTime$207 = previousRenderStartTime)
          : (clampedRenderStartTime$207 = previousRenderStartTime),
        previousRenderStartTime > clampedRenderStartTime$207 &&
          null !== eventIsRepeat &&
          console.timeStamp(
