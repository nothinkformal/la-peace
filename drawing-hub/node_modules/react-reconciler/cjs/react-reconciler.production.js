...
module.exports = function ($$$config) {
  ...
  function updateSuspenseComponent(current, workInProgress, renderLanes) {
    ...
    if (showFallback)
      return (
        ...
        (dehydrated$75 = prevState.sibling),
  ...
  function attemptEarlyBailoutIfNoScheduledUpdate(
    ...
    switch (workInProgress.tag) {
      ...
      case 31:
        ...
        break;
      case 13:
        var state$86 = workInProgress.memoizedState;
        if (null !== state$86) {
          ...
          if (state$86 || 0 !== (renderLanes & primaryChildLanes))
      ...
      case 19:
        ...
        state$86 = 0 !== (renderLanes & workInProgress.childLanes);
        state$86 ||
          (propagateParentContextChanges(
            current,
            workInProgress,
  ...
  function appendAllChildren(
    ...
    if (supportsMutation)
      ...
      for (var node$89 = workInProgress.child; null !== node$89; ) {
        if (5 === node$89.tag) {
          ...
          if (22 === node$89.tag && null !== node$89.memoizedState)
            (instance = node$89.child),
              null !== instance && (instance.return = node$89),
              appendAllChildren(parent, node$89, !0, !0);
          else if (null !== node$89.child) {
            node$89.child.return = node$89;
            node$89 = node$89.child;
            continue;
          }
        if (node$89 === workInProgress) break;
        for (; null === node$89.sibling; ) {
          if (null === node$89.return || node$89.return === workInProgress)
            return;
  ...
  function updateHostComponent(current, workInProgress, type, newProps) {
    if (supportsMutation)
      ...
      var currentInstance = current.stateNode,
        oldProps$92 = current.memoizedProps;
      if (
        (current = doesRequireClone(current, workInProgress)) ||
        oldProps$92 !== newProps
      ) {
        ...
        oldProps$92 === currentInstance
          ...
          : (markCloned(workInProgress),
            ...
            (workInProgress.stateNode = oldProps$92),
            current && appendAllChildren(oldProps$92, workInProgress, !1, !1));
    ...
    if (didBailout)
      for (var child$95 = completedWork.child; null !== child$95; )
        (newChildLanes |= child$95.lanes | child$95.childLanes),
          (subtreeFlags |= child$95.subtreeFlags & 1206910976),
          (subtreeFlags |= child$95.flags & 1206910976),
      ...
      case 5:
        ...
        if (null !== current && null != workInProgress.stateNode)
          ...
          if (popHydrationState(workInProgress))
            ...
            markCloned(workInProgress);
            appendAllChildren(instance$105, workInProgress, !1, !1);
            workInProgress.stateNode = instance$105;
            finalizeInitialChildren(
              instance$105,
              type,
              newProps,
    ...
    switch (finishedWork.tag) {
      ...
      case 3:
        ...
        if (flags & 4) {
          ...
          if (supportsPersistence) {
            ...
            try {
              replaceContainerChildren(flags, root),
                (viewTransitionMutationContext = !0);
            } catch (error) {
              captureCommitPhaseError(finishedWork, finishedWork.return, error);
            }
      ...
      case 22:
        ...
        var prevOffscreenSubtreeIsHidden = offscreenSubtreeIsHidden,
          ...
          prevOffscreenDirectParentIsHidden$147 = offscreenDirectParentIsHidden;
        offscreenSubtreeIsHidden = prevOffscreenSubtreeIsHidden || ii;
        offscreenDirectParentIsHidden =
          prevOffscreenDirectParentIsHidden$147 || ii;
        offscreenSubtreeWasHidden =
          ...
          switch (hostParentFiber.tag) {
            ...
            case 5:
              ...
              hostParentFiber.flags & 32 &&
                (resetTextContent(parent$131), (hostParentFiber.flags &= -33));
    ...
    if (null !== root) {
      ...
      if (0 !== currentEntangledLane) {
        ...
        for (var i = 0; i < root.length; i++) {
          ...
          -1 === root$19.indexOf(transitionType) &&
            root$19.push(transitionType);
        }
      }
    }
