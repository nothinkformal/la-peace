...
exports.getFragmentInstanceOrTextInstanceSiblings = function (fiber) {
...
exports.getFragmentParentInstanceOrContainerFiber =
  getFragmentParentInstanceOrContainerFiber;
exports.getFragmentPortalContainerInfo = function (fiber) {
  for (fiber = fiber.return; null !== fiber; ) {
    if (4 === fiber.tag) return fiber.stateNode.containerInfo;
    if (3 === fiber.tag || 5 === fiber.tag || 27 === fiber.tag) break;
    fiber = fiber.return;
  }
  return null;
...
exports.getNextSiblingInstanceOrTextInstanceFiber = function (fiber) {
  traverseVisibleInstancesAndTextInstances(fiber.sibling, !1, findNextSibling);
  fiber = searchTarget;
  searchTarget = null;
  return fiber;
};
...
exports.isFragmentContainedByFiber = function (fragmentFiber) {
  ...
  for (
    fragmentFiber = getFragmentParentInstanceOrContainerFiber(fragmentFiber);
    null !== current;

  ) {
    if (
      !(
        (5 !== current.tag && 3 !== current.tag && 27 !== current.tag) ||
...
exports.traverseFragmentInstancesAndTextInstances = function (
  fragmentFiber,
  fn,
  a,
  b,
...
exports.traverseFragmentInstancesAndTextInstancesDeeply = function (
  fragmentFiber,
  fn,
  a,
  b,
